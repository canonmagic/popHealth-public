module Api
  module Admin
    class UsersController < ApplicationController
      ...
      def index
        log_call LogAction::SEARCH, "API Admin Users Controller - List all users"
      ...
      def promote
        log_call LogAction::UPDATE, "API Admin Users Controller - Promote an user"
      ...
      def demote
        log_call LogAction::UPDATE, "API Admin Users Controller - Demote an user"
      ...
      def enable
        log_call LogAction::UPDATE, "API Admin Users Controller - Enable an user"
      ...
      def disable
        log_call LogAction::UPDATE, "API Admin Users Controller - Disable an user"
      ...
      def approve
        log_call LogAction::UPDATE, "API Admin Users Controller - Approve an user"
      ...
      def update_npi
        log_call LogAction::UPDATE, "API Admin Users Controller - Update user NPI"
