   ...
   def self.update_system_js
    ...
    def self.materialize_measures(hqmf_document, meta_data={})
      ...
      hqmf_document.populations.each_with_index do |pop,population_index|
        ...
        measure = HealthDataStandards::CQM::Measure.new ({nqf_id: hqmf_document.id || meta_data["nqf_id"],hqmf_id: hqmf_document.hqmf_id,hqmf_set_id: hqmf_document.hqmf_set_id,   hqmf_version_number: hqmf_document.hqmf_version_number, cms_id: hqmf_document.cms_id, name: hqmf_document.title, title: hqmf_document.title, description: hqmf_document.description, type: meta_data["type"], category: meta_data["category"], map_fn: HQMF2JS::Generator::Execution.measure_js(hqmf_document, population_index, options), continuous_variable: continuous_variable, episode_of_care: meta_data["episode_of_care"], hqmf_document:  hqmf_document.to_json })
