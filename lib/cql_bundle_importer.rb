...
#require_relative 'cql_ext/value_set.rb'
#require_relative 'cql_ext/measure.rb'
...
module CqlBundle
  class CqlBundleImporter
    ...
    def self.unpack_and_store_valuesets(zip, bundle)
      ...
      begin
        puts "\rLoading ValueSets, this may take several minutes..."
        ...
        csv.each do |row|
          ...
          codes << CQM::Concept.new(code: row['Code'], code_system_oid: row['CodeSystemOID'], code_system_name: row['CodeSystemName'],
                                    code_system_version: row['CodeSystemVersion'], display_name: row['Descriptor'].encode('utf-8',
